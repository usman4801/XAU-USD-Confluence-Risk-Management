...
st.sidebar.markdown("---")
st.sidebar.caption("Data Source: Real-Time Binance Spot Candles (1m)")

# --- FETCH REAL LIVE CANDLES FROM BINANCE API ---
@st.cache_data(ttl=5) # Refresh every 5 seconds for live candle movement
